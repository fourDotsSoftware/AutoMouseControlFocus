...
;copy translations end
  ...
  !define MUI_FILE "AutoMouseControlFocus"
  !define MUI_VERSION ""
  !define MUI_PRODUCT "AutoMouseControlFocus"
  !define PRODUCT_SHORTCUT "Auto Mouse Control Focus"
  !define PRODUCT_VERSION "1.0"
  
  !define MUI_ICON "auto-mouse-control-focus-48.ico"
...
;  !define MUI_FINISHPAGE_SHOWREADME "$INSTDIR\readme.txt"
  ...
  Name "Auto Mouse Control Focus"
  OutFile "AutoMouseControlFocusSetup.exe"

  InstallDir "$PROGRAMFILES\4dots Software\${PRODUCT_SHORTCUT}"

  InstallDirRegKey HKLM "Software\4dots Software\Auto Mouse Control Focus" ""
...
;create start-menu items
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_SHORTCUT}\Auto Mouse Control Focus - User's Manual.url.lnk" "$INSTDIR\AutoMouseControlFocus - User's Manual.url" "" "$INSTDIR\Auto Mouse Control Focus - User's Manual.url" 0
...
!endif
  ...
  ;!insertmacro InstallLib REGDLL $ALREADY_INSTALLED NOREBOOT_NOTPROTECTED .\AutoMouseControlFocusShellExtx64.dll $SYSDIR\AutoMouseControlFocusShellExt.dll $SYSDIR
  SetRegView 64
...
;   ExecWait '"$INSTDIR\vcredist_x86.exe" /q'
  ;!insertmacro InstallLib REGDLL $ALREADY_INSTALLED NOREBOOT_NOTPROTECTED .\AutoMouseControlFocusShellExt_vs2008_w7_x86.dll $SYSDIR\AutoMouseControlFocusShellExt.dll $SYSDIR
...
;Add files
  ...
  File "Auto Mouse Control Focus - User's Manual.url";
  
  File "4dots Software Product CATALOG.url"
  File "license_agreement.rtf"       
     
  File /oname=4dotsAdminActions.exe "C:\code\Misc\4dotsLanguageDownloader\bin\Debug\4dotsAdminActions-32.exe"
             
  File "MouseKeyboardLibrary.dll"
  File "C:\code\com.4dots-software\com.4dots-software.download-software\com.4dots-software.download-software\bin\Debug\com.4dots-software.download-software.dll"
...
;write uninstall information to the registry
 ...
 ;Store installation folder
  WriteRegStr HKLM "Software\4dots Software\Auto Mouse Control Focus" "" $INSTDIR
  WriteRegStr HKLM "Software\4dots Software\Auto Mouse Control Focus" "InstallationDirectory" $INSTDIR
...
;  !insertmacro UnInstallLib REGDLL NOTSHARED NOREBOOT_NOTPROTECTED $SYSDIR\AutoMouseControlFocusShellExt.dll
  SetRegView 64
   SetShellVarContext all
; 64bit things here
...
;Delete Uninstaller And Unistall Registry Entries
  ...
  DeleteRegKey HKLM "Software\4dots Software\Auto Mouse Control Focus"
  DeleteRegKey HKCU "Software\4dots Software\Auto Mouse Control Focus"
...
Function .onInstSuccess
 ...
 ExecShell "" "https://www.4dots-software.com/auto-mouse-control-focus/how-to-use.php?afterinstall=true&version=${PRODUCT_VERSION}";
...
Function OpenWebpageFunction
  ExecShell "" "http://www.4dots-software.com/auto-mouse-control-focus/how-to-use.php?afterinstall=true"
FunctionEnd

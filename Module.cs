...
namespace AutoMouseControlFocus
{
    class Module
    {
        ...
        public static string ApplicationName = "Auto Mouse Control Focus";
        ...
        public static string DownloadURL = "https://www.4dots-software.com/d/AutoMouseControlFocus/";
        public static string HelpURL = "https://www.4dots-software.com/auto-mouse-control-focus/how-to-use.php";
        public static string ProductWebpageURL = "https://www.4dots-software.com/auto-mouse-control-focus/";
        public static string BuyURL = "https://www.4dots-software.com/store/buy-auto-mouse-control-focus.php";
        public static string VersionURL = "http://cssspritestool.com/versions/auto-mouse-control-focus.txt";

        public static int NumberOfFilesProcessed = 0;

        public static string TipText = TranslateHelper.Translate("Great application to automaticallly focus on Control while you hover it with the mouse.");                   
